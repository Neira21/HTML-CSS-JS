...
function toggleClass(){
    if( text.getAttribute("class") == "newClass") {
...
responsive=[
    {breakPoint:{width:0,item:1}}, //si el ancho es mayor a 0 (Mostrar un item)
    {breakPoint:{width:600,item:2}}, //si el ancho es mayor a 600 (Mostrar 2 items)
    {breakPoint:{width:1000,item:4}} //si el ancho es mayor a 1000 (Mostrar 4 items)
]
